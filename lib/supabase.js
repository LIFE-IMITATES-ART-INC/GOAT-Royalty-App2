...
export const supabaseHelpers = {
  ...
  async getUserTracks(userId) {
    try {
      ...
      return { data: [], error: error.message || 'Failed to fetch tracks' }
    }
  },
  ...
  async getUserRoyalties(userId) {
    try {
      ...
      return { data: [], error: error.message || 'Failed to fetch royalties' }
    }
  },
  ...
  async saveTrack(trackData) {
    try {
      ...
      return { data: null, error: error.message || 'Failed to save track' }
    }
  },
  ...
  async updateTrack(trackId, updates) {
    try {
      ...
      return { data: null, error: error.message || 'Failed to update track' }
    }
  },
  ...
  async getAnalytics(userId) {
    try {
      const [tracksResult, royaltiesResult, contractsResult] = await Promise.all([
      ...
      return {
        ...
        errors: [error.message || 'Failed to fetch analytics']
      }
    }
  },
  ...
  async getUserContracts(userId) {
    try {
      ...
      return { data: [], error: error.message || 'Failed to fetch contracts' }
    }
  },
  ...
  async saveRoyalty(royaltyData) {
    try {
      ...
      return { data: null, error: error.message || 'Failed to save royalty' }
    }
  },
  ...
  async updateRoyalty(royaltyId, updates) {
    try {
      ...
      return { data: null, error: error.message || 'Failed to update royalty' }
    }
  },
